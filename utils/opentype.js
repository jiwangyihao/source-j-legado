var opentype = (() => {
  ...
  var __toCommonJS = (mod) =>
    __copyProps(__defProp({}, "__esModule", { value: true }), mod); // src/opentype.js
  ...
  length_bits[28] = 0;
  length_base[28] = 258; // src/util.js
  function isBrowser() {
    return (
  ...
  var bbox_default = BoundingBox; // src/path.js
  function Path() {
    this.commands = [];
    this.fill = "black";
    this.stroke = null;
  ...
  var path_default = Path; // src/check.js
  ...
  var check_default = { fail, argument, assert: argument }; // src/types.js
  var LIMIT16 = 32768;
  ...
  Parser.prototype.parseDeltaSetIndexMap = function () {
    ...
    if (!mapCount) return { format, entryFormat };
  ...
  Parser.prototype.parseTupleVariationHeader = function (axisCount, flavor) {
    ...
    const result = {
      ...
      flags: { embeddedPeakTuple, intermediateRegion, privatePointNumbers }
    };
    if (flavor === "gvar") {
  ...
  var windowsLanguages = {
    ...
    15370: "es-PY",
    10250: "es-PE",
    20490: "es-PR", // Microsoft has defined two different language codes for
  ...
  var platforms = { 0: "unicode", 1: "macintosh", 2: "reserved", 3: "windows" };
  ...
  function makeCmapTable(glyphs) {
    ...
    let cmapTable = [
      ...
      { name: "numTables", type: "USHORT", value: isPlan0Only ? 1 : 2 }, // CMAP 4 header
  ...
  var cmap_default = { parse: parseCmapTable, make: makeCmapTable }; // src/encoding.js
  ...
  function addGlyphNamesToUnicodeMap(font) {
    ...
    for (let i = 0; i < charCodes.length; i += 1) {
      ...
      if (font._IndexToUnicodeMap[glyphIndex] === void 0) {
        font._IndexToUnicodeMap[glyphIndex] = { unicodes: [parseInt(c)] };
      } else {
  ...
  var draw_default = { line }; // src/tables/cpal.js
  function parseCpalTable(data, start) {
    ...
    p.relativeOffset = colorRecordsArrayOffset;
    return { version, numPaletteEntries, colorRecords, colorRecordIndices };
  }
  ...
  function parseColor(color, targetFormat = "hexa") {
    ...
    if ((isRaw && returnRaw) || color === "currentColor") {
      ...
      globalThis.window &&
      globalThis.window.HTMLCanvasElement &&
      /^[a-z]+$/i.test(color)
    ) {
  ...
  var glyph_default = Glyph; // src/glyphset.js
  ...
  var cff_default = { parse: parseCFFTable, make: makeCFFTable }; // src/tables/head.js
  ...
  var head_default = { parse: parseHeadTable, make: makeHeadTable }; // src/tables/hhea.js
  ...
  var hhea_default = { parse: parseHheaTable, make: makeHheaTable }; // src/tables/hmtx.js
  ...
  function parseHmtxTableOnLowMemory(font, data, start, numMetrics, numGlyphs) {
    ...
    for (let i = 0; i < numGlyphs; i += 1) {
      ...
      font._hmtxTableData[i] = { advanceWidth, leftSideBearing };
    }
  }
  ...
  var hmtx_default = { parse: parseHmtxTable, make: makeHmtxTable }; // src/tables/ltag.js
  ...
  var ltag_default = { make: makeLtagTable, parse: parseLtagTable }; // src/tables/maxp.js
  ...
  var maxp_default = { parse: parseMaxpTable, make: makeMaxpTable }; // src/tables/os2.js
  var unicodeRanges = [
    { begin: 0, end: 127 }, // Basic Latin
  ...
  var post_default = { parse: parsePostTable, make: makePostTable }; // src/tables/gsub.js
  ...
  var meta_default = { parse: parseMetaTable, make: makeMetaTable }; // src/tables/colr.js
  ...
  var colr_default = { parse: parseColrTable, make: makeColrTable }; // src/tables/fvar.js
  ...
  var fvar_default = { make: makeFvarTable, parse: parseFvarTable }; // src/tables/stat.js
  ...
  function parseSTATTable(data, start, fvar) {
    ...
    return { version, axes, values, elidedFallbackNameID };
  }
  ...
  var stat_default = { make: makeSTATTable, parse: parseSTATTable }; // src/tables/avar.js
  ...
  function parseAvarTable(data, start, fvar) {
    ...
    for (let i = 0; i < axisCount; i++) {
      ...
      for (let j = 0; j < positionMapCount; j++) {
        ...
        axisValueMaps.push({ fromCoordinate, toCoordinate });
      }
      axisSegmentMaps.push({ axisValueMaps });
    }
    return { version: [tableVersionMajor, tableVersionMinor], axisSegmentMaps };
  }
  var avar_default = { make: makeAvarTable, parse: parseAvarTable }; // src/tables/cvar.js
  ...
  var cvar_default = { make: makeCvarTable, parse: parseCvarTable }; // src/tables/gvar.js
  ...
  var gvar_default = { make: makeGvarTable, parse: parseGvarTable }; // src/tables/gasp.js
  ...
  var gasp_default = { parse: parseGaspTable, make: makeGaspTable }; // src/tables/svg.js
  ...
  var svg_default = { make: makeSvgTable, parse: parseSvgTable }; // src/tables/sfnt.js
  function log2(v) {
  ...
  function fontToSfntTable(font) {
      ...
      Object.assign(
        {
          ...
          ulUnicodeRange2,
          ulUnicodeRange3,
          ulUnicodeRange4, // See http://typophile.com/node/13081 for more info on vertical metrics.
    ...
    const optionalTableArgs = { avar: [font.tables.fvar], fvar: [font.names] };
  ...
  var layout_default = Layout; // src/position.js
  ...
  var position_default = Position; // src/substitution.js
  ...
  Substitution.prototype.addLigature = function (
    ...
    const ligatureTable = { ligGlyph: ligature.by, components: ligComponents };
    let pos = this.binSearch(subtable.coverage.glyphs, coverageGlyph);
    if (pos >= 0) {
  ...
  var substitution_default = Substitution; // src/palettes.js
  var PaletteManager = class {
     ...
     */ deleteColor(colorIndex, replacementIndex) {
      ...
      if (colrTable) {
        ...
        this.font.tables.colr = { ...colrTable, layerRecords };
      }
     ...
     */ add(glyphIndex, layers, position) {
      ...
      for (const layer of layers) {
        const glyphID = Number.isInteger(layer.glyph)
          ? layer.glyph
          : layer.glyph.index;
        newLayers.push({ glyphID, paletteIndex: layer.paletteIndex });
      }
  ...
  var decodeSvgDocument = globalThis.DecompressionStream
  ...
  var glyf_default = { getPath, parse: parseGlyfTable }; // src/variationprocessor.js
  ...
  var xUnitVector = {
    x: 1,
    y: 0,
    axis: "x", // Gets the projected distance between two points.
  ...
  var yUnitVector = {
    x: 0,
    y: 1,
    axis: "y", // Gets the projected distance between two points.
    // o1/o2 ... if true, respective original position is used.
    distance: function (p1, p2, o1, o2) {
  ...
  var hintingtt_default = Hinting; // src/tokenizer.js
  function Token(char) {
    this.char = char;
    this.state = {};
  ...
  Tokenizer.prototype.registerContextChecker = function (
    ...
    if (this.getContext(contextName))
      return { FAIL: `context name '${contextName}' is already registered.` };
  ...
  var tokenizer_default = Tokenizer; // src/char.js
  ...
  FeatureQuery.prototype.lookupFeature = function (query) {
    ...
    const feature = this.getFeature({ tag: query.tag, script: query.script });
    if (!feature)
      return new Error(
        `font '${
          (
          ...
          case "11":
            ...
            if (substitution) {
              substitutions.splice(
                currentIndex,
                1,
                new SubstitutionAction({ id: 11, tag: query.tag, substitution })
              );
            }
            break;
          case "12":
            ...
            if (substitution) {
              substitutions.splice(
                currentIndex,
                1,
                new SubstitutionAction({ id: 12, tag: query.tag, substitution })
              );
            }
            break;
          case "63":
            ...
            if (Array.isArray(substitution) && substitution.length) {
              substitutions.splice(
                currentIndex,
                1,
                new SubstitutionAction({ id: 63, tag: query.tag, substitution })
              );
            }
            break;
          case "41":
            ...
            if (substitution) {
              substitutions.splice(
                currentIndex,
                1,
                new SubstitutionAction({ id: 41, tag: query.tag, substitution })
              );
            }
            break;
          case "21":
            ...
            if (substitution) {
              substitutions.splice(
                currentIndex,
                1,
                new SubstitutionAction({ id: 21, tag: query.tag, substitution })
              );
            }
            break;
          case "51":
  ...
  var featureQuery_default = FeatureQuery; // src/features/arab/contextCheck/arabicWord.js
  ...
  var applySubstitution_default = applySubstitution; // src/features/arab/arabicPresentationForms.js
  ...
  var arabicPresentationForms_default = arabicPresentationForms; // src/features/arab/arabicRequiredLigatures.js
  ...
  var arabicRequiredLigatures_default = arabicRequiredLigatures; // src/features/ccmp/contextCheck/ccmpReplacement.js
  ...
  var ccmpReplacementLigatures_default = ccmpReplacementLigatures; // src/features/latn/contextCheck/latinWord.js
  ...
  var latinLigatures_default = latinLigature; // src/features/thai/contextCheck/thaiWord.js
  ...
  var thaiGlyphComposition_default = thaiGlyphComposition; // src/features/thai/thaiLigatures.js
  ...
  var thaiLigatures_default = thaiLigatures; // src/features/thai/thaiRequiredLigatures.js
  ...
  var thaiRequiredLigatures_default = thaiRequiredLigatures; // src/features/unicode/contextCheck/variationSequenceCheck.js
  ...
  var variationSequences_default = unicodeVariationSequence; // src/bidi.js
  ...
  var bidi_default = Bidi; // src/font.js
  ...
  var font_default = Font; // src/tables/hvar.js
  function parseHvarTable(data, start) {
    ...
    return { version, itemVariationStore, advanceWidth, lsb, rsb };
  }
  function makeHvarTable() {
    console.warn("Writing of hvar tables is not yet supported.");
  }
  var hvar_default = { make: makeHvarTable, parse: parseHvarTable }; // src/tables/gdef.js
  ...
  var gdef_default = { parse: parseGDEFTable }; // src/tables/gpos.js
  ...
  var gpos_default = { parse: parseGposTable, make: makeGposTable }; // src/tables/kern.js
  ...
  var kern_default = { parse: parseKernTable }; // src/tables/loca.js
  ...
  var loca_default = { parse: parseLocaTable }; // src/opentype.js
